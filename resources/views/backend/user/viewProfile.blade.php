                    ...
                    <div class="col-12">
                        ...
                        <div class="box box-widget widget-user">
                            ...
                            <div class="widget-user-header bg-black" >
                                ...
                                <a href="{{route("editeProfile")}}" style="float: right" class="btn btn-rounded btn-success mb-5">
                                    Edite Profile
                                </a>
                            ...
                            <div class="widget-user-image">
                                <img class="rounded-circle"
                                     src="{{(!empty($user->image) ? url('upload/userImages/'.$user->image) : url('upload/no_image.jpg'))}}" alt="User Avatar">
                            </div>
